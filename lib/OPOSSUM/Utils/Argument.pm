...
OPOSSUM::Utils::Argument - Utility functions for argument handling
...
package OPOSSUM::Utils::Argument;
...
=head2 rearrange
 ...
 Example   : use OPOSSUM::Utils::Argument qw(rearrange);
...
sub rearrange
{
    ...
    if ($order eq "OPOSSUM::Utils::Argument") {

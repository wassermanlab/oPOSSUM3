...
OPOSSUM::ZscoreResultSet.pm - module to hold the results of a Zscore analysis
...
=head2 add_result
 ...
 Returns  : The OPOSSUM::Analysis::ZscoreResult object just added
...
sub add_result
{
    ...
    unless ($result->isa("OPOSSUM::Analysis::ZscoreResult")) {
        carp "Argument is not an OPOSSUM::Analysis::ZscoreResult\n";
        return;
    }

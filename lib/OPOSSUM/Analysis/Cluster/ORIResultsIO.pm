...
OPOSSUM::Analysis::Cluster::ORIResultsIO - Object for the I/O of
OPOSSUM::Analysis::Cluster::ORIResultSet objects
...
package OPOSSUM::Analysis::Cluster::ORIResultsIO;
...
=head2 new
 ...
 Title    : new
 Usage    : $orIO = OPOSSUM::Analysis::Cluster::ORIResultsIO->new(
					    -file	=> $in_file);
 Function : Create a new OPOSSUM::Analysis::Cluster::ORIResultsIO object.
 Returns  : An OPOSSUM::Analysis::Cluster::ORIResultsIO object.
...
=head2 write_results
 ...
 Returns  : Nothing
 Args     : An OPOSSUM::Analysis::Cluster::ORIResultSet object
...
sub write_results
{
    ...
    if (!$results || !$results->isa("OPOSSUM::Analysis::Cluster::ORIResultSet")) {
	carp "no results provided or results is not a"
		. " OPOSSUM::Analysis::Cluster::ORIResultSet object";
	return;
    }
...
sub _read_results
{
	...
	{
	    $results->add_result(OPOSSUM::Analysis::Cluster::ORIResult->new(
						    -id		=> $vals[0],
						    -bg_rate	=> $vals[1],
						    -t_rate	=> $vals[2],
						    -bg_prop	=> $vals[3],
...
sub _write_results
{
    ...
    print $fh "TFCluster\t\tbRate\ttRate\tbProp\ttProp\tORI\n";

...
OPOSSUM::Analysis::Cluster::ORIResultSet.pm - module to hold the results of
an ORI analysis
...
package OPOSSUM::Analysis::Cluster::ORIResultSet;
...
=head2 new
 ...
 Title    : new
 Usage    : $ors = OPOSSUM::Analysis::Cluster::ORIResultSet->new();
 Function : Create a new OPOSSUM::Analysis::Cluster::ORIResultSet object.
...
=head2 add_result
 ...
 Returns  : Nothing
 Args     : An OPOSSUM::Analysis::Cluster::ORIResult object
...
sub add_result
{
    ...
    if (!$new_result->isa("OPOSSUM::Analysis::Cluster::ORIResult")) {
    	carp "not an OPOSSUM::Analysis::Cluster::ORIResult";
	return;
    }
...
=head2 sort_by
 ...
 Returns  : Nothing
 Args     : [1] an OPOSSUM::Analysis::Cluster::ORIResult field to sort the set on

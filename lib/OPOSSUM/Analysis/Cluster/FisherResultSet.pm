...
OPOSSUM::Analysis::Cluster::FisherResultSet.pm - module to hold the results of a Fisher analysis
...
package OPOSSUM::Analysis::Cluster::FisherResultSet;
...
=head2 new
 ...
 Title    : new
 Usage    : $frs = OPOSSUM::Analysis::Cluster::FisherResultSet->new();
 Function : Create a new OPOSSUM::Analysis::Cluster::FisherResultSet object.
...
=head2 add_result
 ...
 Returns  : The OPOSSUM::Analysis::Cluster::FisherResult object just added
 Args     : An OPOSSUM::Analysis::Cluster::FisherResult object
...
sub add_result
{
    ...
    unless ($result->isa("OPOSSUM::Analysis::Cluster::FisherResult")) {
        carp "Argument is not an OPOSSUM::Analysis::Cluster::FisherResult\n";
        return;
    }

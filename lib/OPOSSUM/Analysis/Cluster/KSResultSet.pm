...
OPOSSUM::Analysis::Cluster::KSResultSet.pm - module to hold the results of a KS analysis
...
package OPOSSUM::Analysis::Cluster::KSResultSet;
...
=head2 new
 ...
 Title    : new
 Usage    : $frs = OPOSSUM::Analysis::Cluster::KSResultSet->new();
 Function : Create a new OPOSSUM::Analysis::Cluster::KSResultSet object.
...
=head2 add_result
 ...
 Returns  : The OPOSSUM::Analysis::Cluster::KSResult object just added
 Args     : An OPOSSUM::Analysis::Cluster::KSResult object
...
sub add_result
{
    ...
    unless ($result->isa("OPOSSUM::Analysis::Cluster::KSResult")) {
        carp "Argument is not an OPOSSUM::Analysis::Cluster::KSResult\n";
        return;
    }
...
=head2 get_result
 ...
 Returns  : An OPOSSUM::Analysis::Cluster::KSResult object

...
OPOSSUM::Analysis::Cluster::KSResultsIO - Object for the I/O of
OPOSSUM::Analysis::Cluster::KSResultSet objects
...
package OPOSSUM::Analysis::Cluster::KSResultsIO;
...
=head2 new
 ...
 Title    : new
 Usage    : $frIO = OPOSSUM::Analysis::Cluster::KSResultsIO->new(
                -file	=> $in_file
            );
 Function : Create a new OPOSSUM::Analysis::Cluster::KSResultsIO object.
 Returns  : An OPOSSUM::Analysis::Cluster::KSResultsIO object.
...
=head2 write_results
 ...
 Returns  : Nothing
 Args     : An OPOSSUM::Analysis::Cluster::KSResultSet object
...
sub write_results
{
    ...
    if (!$results || !$results->isa("OPOSSUM::Analysis::Cluster::KSResultSet")) {
        carp "no results provided or results is not a"
            . " OPOSSUM::Analysis::Cluster::KSResults object";
        return;
    }
...
sub _read_results
{
    ...
    my $results = OPOSSUM::Analysis::Cluster::KSResultSet->new;
    if (!$results) {
        ...
        && $headers[2] eq 'BG_distribution')
    {
        while (my $line = <$fh>) {
            ...
            {
                $results->add_result(
                    OPOSSUM::Analysis::Cluster::KSResult->new(
                        -id         => $vals[0],
                        -p_value    => $vals[1],
...
sub _write_results
{
    ...
    print $fh "TFCluster\tp-value\tBG_distribution\n";

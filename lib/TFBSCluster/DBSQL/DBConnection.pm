...
TFBSCluster::DBSQL::DBConnection - object to encapsulate and manage a databse
connection (wraps a DBI connection).

=head1 SYNOPSIS

 $db = TFBSCluster::DBSQL::DBConnection->new(
     -user   => 'opossum_r',
     -dbname => 'TFBSCluster',
     -host   => 'localhost'
 );
...
package TFBSCluster::DBSQL::DBConnection;
...
=head2 new
 ...
 Title    : new
 Usage    : $db = TFBSCluster::DBSQL::DBConnection->new(
                -user	=> 'possum',
                -host	=> 'localhost',
                -dbname	=> 'TFBSCluster'
            );
 Function : Connect to a database and return connection as a
            TFBSCluster::DBSQL::DBConnection object.
 Returns  : A new TFBSCluster::DBSQL::DBConnection object
